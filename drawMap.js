...
function createMap(nepal) {
    ...
    function createBar(data){
        var deaths = data.filter(function (data) {
            ...
            }).map(function (data) {return data.no;}).reduce(function (a, b) {
        ...
        var pripartial = data.filter(function (data) {return data.Subdivision == "Private Houses Fully Damaged";
        }).map(function (data) {return data.no;}).reduce(function (a, b) {
            return parseInt(a) + parseInt(b);
        }, 0);
        var sum=[];
        ...
        function createBarChart(divId,barChartId){
            ...
            plot.selectAll("text")
                ...
                .enter()
                .append("text")
                .text(function (d){return formatAsInteger(d3.round(d));})
